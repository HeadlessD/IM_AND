...
//  private static final int MAX_FRAME_HEIGHT = 540; // = 1080/2
  private static final int MAX_FRAME_WIDTH = 540; // = 1920/2
  private static final int MAX_FRAME_HEIGHT = 540; // = 1080/2
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      int topOffset = (int)((screenResolution.y - height) * 0.3f); 
   ...
   */
  public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height, boolean isPortrait) {
