...
import com.google.zxing.client.android.PreferencesSettingKeys;
...
//	}
  ...
  void setDesiredCameraParameters(Camera camera, boolean safeMode) {
    ...
    if (prefs.getBoolean(PreferencesSettingKeys.KEY_AUTO_FOCUS, true)) {
      if (safeMode || prefs.getBoolean(PreferencesSettingKeys.KEY_DISABLE_CONTINUOUS_FOCUS, false)) {
    ...
    if (prefs.getBoolean(PreferencesSettingKeys.KEY_INVERT_SCAN, false)) {
    ...
    if(isPortrait())
    {
    	setDisplayOrientation(camera, parameters, 90);
    }
  ...
  private void setDisplayOrientation(Camera camera, Camera.Parameters parameters, int angle)
	{
...
//                Camera.Parameters parameters = camera.getParameters();  
                ...
                if (downPolymorphic != null)
                  downPolymorphic.invoke(parameters, angle);
