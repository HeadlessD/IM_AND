...
public abstract class BaseItemDragAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public BaseItemDragAdapter(List<T> data) {
        super(data);
    }

    public BaseItemDragAdapter(int layoutResId, List<T> data) {
