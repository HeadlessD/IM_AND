...
public class NIM_HeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    NIM_HeaderAndFooterAdapter(RecyclerView.Adapter innerAdapter) {
