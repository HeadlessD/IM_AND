...
public class NIM_PhotoPreviewAct extends NIM_ToolbarAct implements PhotoViewAttacher.OnViewTapListener{
    ...
    private static final String EXTRA_IS_PREVIEW = "EXTRA_IS_PREVIEW";

    private TextView mTitleTv;
    private TextView mSubmitTv;
    private NIM_HackyViewPager mContentHvp;
    private RelativeLayout mChooseRl;
    private TextView mChooseTv;

    private ArrayList<String> mSelectedImages;
    private NIM_PhotoPageAdapter mPhotoPageAdapter;
    ...
    public static Intent newIntent(Context context, int maxChooseCount, ArrayList<String> selectedImages, ArrayList<String> previewImages, int currentPosition, boolean isFromTakePhoto) {
        Intent intent = new Intent(context, NIM_PhotoPreviewAct.class);
    ...
    public static Intent newIntent(Context context, ArrayList<String> previewImages, int currentPosition) {
        Intent intent = new Intent(context, NIM_PhotoPreviewAct.class);
        intent.putStringArrayListExtra(EXTRA_PREVIEW_IMAGES, previewImages);
        intent.putExtra(EXTRA_MAX_CHOOSE_COUNT, Integer.MAX_VALUE);
        intent.putExtra(EXTRA_CURRENT_POSITION, currentPosition);
    ...
    protected void initView(Bundle savedInstanceState) {
        setNoLinearContentView(R.layout.nim_pp_activity_photo_picker_preview);
    ...
    protected void setListener() {
        mChooseTv.setOnClickListener(new NIM_OnNoDoubleClickListener() {
            @Override
            public void onNoDoubleClick(View v) {
                ...
                if (mSelectedImages.contains(currentImage)) {
                    ...
                    mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.nim_pp_ic_cb_normal, 0, 0, 0);
                    renderTopRightBtn();
                } else {
                    if (mMaxChooseCount == 1) {
                        ...
                        mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.nim_pp_ic_cb_checked, 0, 0, 0);
                        renderTopRightBtn();
                    } else {
                        // 多选
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        mPhotoPageAdapter = new NIM_PhotoPageAdapter(this, this, previewImages);
        mContentHvp.setAdapter(mPhotoPageAdapter);
        mContentHvp.setCurrentItem(currentPosition);

        mIsPreView = getIntent().getBooleanExtra(EXTRA_IS_PREVIEW, false);
        if (mIsPreView) {
            mToolbar.setVisibility(View.GONE);
            mChooseRl.setVisibility(View.GONE);
        }
...
//        }
        getMenuInflater().inflate(R.menu.nim_pp_menu_photo_picker_preview, menu);
