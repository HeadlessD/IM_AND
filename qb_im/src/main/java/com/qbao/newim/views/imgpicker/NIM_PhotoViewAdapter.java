...
public abstract class NIM_PhotoViewAdapter<M> extends BaseAdapter {
    ...
    public NIM_PhotoViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final NIM_PhotoViewHolder viewHolder = NIM_PhotoViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
     ...
     * @param helper
     */
    protected void setItemChildListener(NIM_ViewHolderHelper helper) {
    }
