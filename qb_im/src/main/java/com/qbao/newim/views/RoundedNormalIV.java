...
public class RoundedNormalIV extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundedNormalIV(Context context) {
        super(context);
    }

    public RoundedNormalIV(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedNormalIV(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadii[Corner.TOP_LEFT] = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] = a.getDimensionPixelSize(R.styleable.RoundedImageView_riv_corner_radius_bottom_left, -1);
