...
public abstract class NIM_RecyclerViewAdapter<M> extends RecyclerView.Adapter<NIM_RecyclerViewHolder> {
    ...
    protected NIM_HeaderAndFooterAdapter mHeaderAndFooterAdapter;
    ...
    public NIM_RecyclerViewAdapter(RecyclerView recyclerView) {
        mRecyclerView = recyclerView;
        mContext = mRecyclerView.getContext();
        mData = new ArrayList<>();
    }

    public NIM_RecyclerViewAdapter(RecyclerView recyclerView, int defaultItemLayoutId) {
        this(recyclerView);
    ...
    @Override
    public NIM_RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        NIM_RecyclerViewHolder viewHolder = new NIM_RecyclerViewHolder(this, mRecyclerView, LayoutInflater.from(mContext).inflate(viewType, parent, false), mOnRVItemClickListener, mOnRVItemLongClickListener);
     ...
     * @param helper
     */
    protected void setItemChildListener(NIM_ViewHolderHelper helper, int viewType) {
    }
    ...
    @Override
    public void onBindViewHolder(NIM_RecyclerViewHolder viewHolder, int position) {
        // 在设置值的过程中忽略选中状态变化
     ...
     * @param model
     */
    protected abstract void fillData(NIM_ViewHolderHelper helper, int position, M model);
     ...
     */
    public void setOnRVItemClickListener(NIM_OnRVItemClickListener onRVItemClickListener) {
     ...
     */
    public void setOnRVItemLongClickListener(NIM_OnRVItemLongClickListener onRVItemLongClickListener) {
    ...
    public NIM_HeaderAndFooterAdapter getHeaderAndFooterAdapter() {
        if (mHeaderAndFooterAdapter == null) {
            synchronized (NIM_RecyclerViewAdapter.this) {
                if (mHeaderAndFooterAdapter == null) {
                    mHeaderAndFooterAdapter = new NIM_HeaderAndFooterAdapter(this);
                }
            }
        }
