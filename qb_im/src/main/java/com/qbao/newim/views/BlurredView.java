...
public class BlurredView extends RelativeLayout {
    ...
    private void initView(Context context) {
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.nim_blurredview, this);
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        if (null != drawable) {
            ...
            mBlurredBitmap = BitmapUtil.blurBitmap(context, mOriginBitmap, BLUR_RADIUS);
        }
    ...
    public void setBlurredImg(Bitmap blurredBitmap) {
        if (null != blurredBitmap) {
            ...
            mBlurredBitmap = BitmapUtil.blurBitmap(mContext, blurredBitmap, BLUR_RADIUS);
            setImageView();
        }
    }
    ...
    public void setBlurredImg(Drawable blurDrawable) {
        if (null != blurDrawable) {
            ...
            mBlurredBitmap = BitmapUtil.blurBitmap(mContext, mOriginBitmap, BLUR_RADIUS);
            setImageView();
        }
    }
