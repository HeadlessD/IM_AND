...
public class QuickSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        List<String> default_letter = Arrays.asList(context.getResources().getStringArray(R.array.quickSideBarLetters));
        mLetters.addAll(default_letter);

        mTextColor = ContextCompat.getColor(context, android.R.color.black);
        mTextColorChoose = ContextCompat.getColor(context, android.R.color.black);
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.nim_quick_sidebar);
        mTextSizeChoose = context.getResources().getDimensionPixelSize(R.dimen.nim_quick_sidebar_choose);
        mItemHeight = context.getResources().getDimension(R.dimen.height_quick_sidebar_item);
        if (attrs != null) {
