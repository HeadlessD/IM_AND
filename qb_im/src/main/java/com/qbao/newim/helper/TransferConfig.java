...
public class TransferConfig {
    ...
    private ImageView originImageList;
    ...
    public ImageView getOriginImageList() {
        return originImageList;
    }

    public void setOriginImageList(ImageView originImageList) {
    ...
    public static class Builder {
         ...
         * 原始的 ImageView 集合
         */
        public Builder setOriginImageList(ImageView originImageList) {
            this.originImageList = originImageList;
            return this;
        }
