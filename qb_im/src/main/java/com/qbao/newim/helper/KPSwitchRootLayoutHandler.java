...
import com.qbao.newim.util.StatusbarUtils;
...
public class KPSwitchRootLayoutHandler {
    ...
    public KPSwitchRootLayoutHandler(final View rootView) {
        ...
        this.mStatusBarHeight = StatusbarUtils.getStatusBarHeight(rootView.getContext());
        final Activity activity = (Activity) rootView.getContext();
        this.mIsTranslucentStatus = AppUtil.isTranslucentStatus(activity);
    }
