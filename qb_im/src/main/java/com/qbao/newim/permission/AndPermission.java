...
import com.qbao.newim.permission.target.AppActivityTarget;
import com.qbao.newim.permission.target.AppFragmentTarget;
import com.qbao.newim.permission.target.ContextTarget;
import com.qbao.newim.permission.target.SupportFragmentTarget;
...
public class AndPermission {
    ...
    public static
    @NonNull
    RationaleDialog rationaleDialog(@NonNull Context context, String tips, Rationale rationale) {
        return new RationaleDialog(context, tips, rationale);
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull Activity activity, String tips, int requestCode) {
        return new SettingDialog(activity, tips, new SettingExecutor(new AppActivityTarget(activity), requestCode));
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull android.support.v4.app.Fragment fragment, String tips, int requestCode) {
        return new SettingDialog(fragment.getActivity(), tips, new SettingExecutor(new SupportFragmentTarget(fragment), requestCode));
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull android.app.Fragment fragment, String tips, int requestCode) {
        return new SettingDialog(fragment.getActivity(), tips, new SettingExecutor(new AppFragmentTarget(fragment), requestCode));
    }
