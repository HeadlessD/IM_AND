...
public final class T_FRIEND_SERVER_DEL_RQ extends Table {
  ...
  public static T_FRIEND_SERVER_DEL_RQ getRootAsT_FRIEND_SERVER_DEL_RQ(ByteBuffer _bb, T_FRIEND_SERVER_DEL_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public T_FRIEND_SERVER_DEL_RQ __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
