...
public class ParallaxScaleBehavior extends AppBarLayout.Behavior{
    ...
    private static final int ANIMATE_PER_SECOND = 100;
    ...
    private View getParallaxView(AppBarLayout appBarLayout) {
        ...
        return appBarLayout.findViewById(R.id.user_image);
    }
    ...
    public static <V extends View> ParallaxScaleBehavior from(V view) {
        ViewGroup.LayoutParams params = view.getLayoutParams();
        if (!(params instanceof CoordinatorLayout.LayoutParams)) {
            throw new IllegalArgumentException("not CoordinatorLayout child view");
        }
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params).getBehavior();
        if (!(behavior instanceof ParallaxScaleBehavior)) {
            throw new IllegalArgumentException("not ParallaxScaleBehavior");
        }
        return (ParallaxScaleBehavior) behavior;
    }
}
