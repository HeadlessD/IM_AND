...
public final class T_GROUP_LEADER_CHANGE_RQ extends Table {
  ...
  public static T_GROUP_LEADER_CHANGE_RQ getRootAsT_GROUP_LEADER_CHANGE_RQ(ByteBuffer _bb, T_GROUP_LEADER_CHANGE_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public T_GROUP_LEADER_CHANGE_RQ __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
