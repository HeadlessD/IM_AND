...
public final class T_CLIENT_FANS_SEND_MESSAGE_RQ extends Table {
  ...
  public static T_CLIENT_FANS_SEND_MESSAGE_RQ getRootAsT_CLIENT_FANS_SEND_MESSAGE_RQ(ByteBuffer _bb, T_CLIENT_FANS_SEND_MESSAGE_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public T_CLIENT_FANS_SEND_MESSAGE_RQ __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static void startT_CLIENT_FANS_SEND_MESSAGE_RQ(FlatBufferBuilder builder) { builder.startObject(4); }
